...
To develop an intergenerational [continuous cover forestry](http://silviculture.org.uk/continuous-cover-forestry/) operation using native species (via afforestation or plantation transition) through a cooperative governance structure.
...
Afforestation culminating in CCF will sequester substantial amounts of carbon. Currently, the emission trading scheme's native forest schedule is based on regenerating forest and shrubland.  Recent [research](https://pureadvantage.org/carbon-sequestration-by-native-forest-setting-the-record-straight/) suggests the true storage capacity of managed native forest has been dramatically underestimated and more closely approaches that of a pine planatation.
...
Currently, we are at Step 1 of the process: gauging interest of potential participants. We are also looking at the possibility of developing a pilot project in Otago.

<br>

<div class = "blue">
If the concept interests you (regardless of place of residence), you can register your interest by emailing [Nathan](mailto:nathan@reproducible.co.nz) to be included on a mailing list for monthly updates. Feel free to mention possible ways you may like to be involved. You can also help us learn about you by taking this [survey](survey.html).
